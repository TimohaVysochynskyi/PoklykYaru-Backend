...
$guests = array(
    ...
    [
        ...
        'Голова національного природного парку „Холодний Яр“', 'Лідер гурту "Тінь Сонця"', 'Генерал Збройних сил України', 'Військовий волонтер',
            ...
            <ul class="tabir__features-list">
                <li>
                    <a onmouseout="$('#tabir-feature-text-1').slideDown(200);" href="javascript:void(0)">
                        ...
                        <p class="tabir__feature-text" id="tabir-feature-text-1">&nbsp&nbspЗ цією метою заснований
                            табір. Ми переконані, що майбутнє України за відповідальними. Тому формуємо літню програму
                            так, щоб молодь навчалась приймати самостійні рішення і брати відповідальність за себе та
                            побратимів</p>
                    </a>
                </li>
                <li>
                    <a onmouseout="$('#tabir-feature-text-2').slideDown(200);" href="javascript:void(0)">
                        ...
                        <p class="tabir__feature-text" id="tabir-feature-text-2">&nbsp&nbspПобратимство - головний
                            елемент виховання гідної людини. Взаємопідтримка для нас понад усе. Дисципліна – основа
                            порядку. Чіткий розпорядок дня, рівні правила і можливості, відповідальність за колектив.
                            Патріотична молодь, що шанує рідне, беззаперечно стане справжнім фундаментом сильної
                            України.</p>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a onmouseout="$('#tabir-feature-text-4').slideDown(200);" href="javascript:void(0)">
                        ...
                        <p class="tabir__feature-text" id="tabir-feature-text-4">&nbsp&nbspХолодноярський ліс,
                            віддаленість від великих міст, свіже повітря, смачна і здорова їжа. Телефони видаються
                            вихованцям лише на одну годину ввечері для зв'язку з рідними, що повністю занурює дитину у
                            світ Поклик Яру.</p>
                    </a>
                </li>
                <li>
                    <a onmouseout="$('#tabir-feature-text-5').slideDown(200);" href="javascript:void(0)">
                        ...
                        <p class="tabir__feature-text" id="tabir-feature-text-5">&nbsp&nbspНаша команда стане для
                            вихованців не лише наставниками і прикладом, а й справжніми друзями. Ми тримаємо зв'язок з
