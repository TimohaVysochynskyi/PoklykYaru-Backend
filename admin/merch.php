	...
	<main class="container" style="height: auto; justify-content: flex-start;">
		...
		<div id="create-new-merch-wrapper">
			<div class="create-new-merch">
				...
				<form action="./validation/merch/create_merch.php" method="post" id="create-new-merch__form"
					...
					<input type="file" name="create-new-merch__image[]" placeholder="Картинка" multiple>
