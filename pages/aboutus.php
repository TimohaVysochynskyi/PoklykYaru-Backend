...
<body>
    ...
    <main class="container" style="margin-top: 100px;">
    	<div class="aboutus-wraper">
    		<a class="aboutus__item wow fadeInLeft" href="./team.php"><h2 class="aboutus__item-title">наша команда</h2></a>
    		<a class="aboutus__item wow fadeInRight" href="./history.php"><h2 class="aboutus__item-title" style="color: #293C43;">історія</h2></a>
    		<a class="aboutus__item wow fadeInLeft" href="./feedback.php"><h2 class="aboutus__item-title">відгуки та змі</h2></a>
    	</div>
    </main>
