        ...
        <ul class="event__list-wrpper">
            ...
            <li class="event-block wow fadeInLeft" id="туристичне змагання ім. в. чучупаки">
                <div class="event__row">
                    <section class="event__info">
                        <div class="event-paralelogram"></div>
                        <h1 class="event-title">туристичне змагання ім. в. чучупаки</h1>
                        <h2 class="event-time">13.01.2024</h2>
                    </section>
                </div>
                <div class="event__row">
                    <div class="event__col">
                        <div class="event-paralelogram-bg"></div>
                        <p class="event-text">Новий формат нашого заходу, яким продовжуємо популяризувати Головного Отамана Холодного Яру.</p>
                        <p class="event-text">🔸40 км шляху, що гартує козаків.</p>
                        <p class="event-text">Маршрут, який пройдуть найсильніші. Фініш стане найбільшою перемогою над собою, бо Холодний Яр обов’язково випробує на стійкість. </p>
                        <p class="event-text">🔸Команда.</p>
                        <p class="event-text">Команда — пріоритет. Формуйте команду та власну стратегію до перемоги. Злагодженість і впевненість у свої сили стануть найкращими помічниками.</p>
                        <p class="event-text">🔸Місцевість, що дихає історією.</p>
                        <p class="event-text">Холодний Яр — місце, де об’єднувались козаки, гайдамаки та повстанці для боротьби з одвічним ворогом. Не одне покоління запалювало вогонь, який горить і сьогодні. </p>
