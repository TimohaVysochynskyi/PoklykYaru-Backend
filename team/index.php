    ...
    <div class="istoryk-wrapper">
		...
		<p class="team__text wow fadeInRight" style="font-size: 2.5vh">
			Координатор організації «Поклик Яру». 
							<br><br>
			Людина, що продовжувала справу Євгена Коновальця, Василя Чучупаки, Юрія Горліс-Горського і ще багатьох відданих націоналістів.
<br><br>
			Він загинув за українське майбутнє. <br>
			Він щиро вірив в те, що робив. <br>
			Він був ідейником, якого наслідувала вся команда ПЯ і ще багато людей. <br>
			Він — схід сонця нашої Держави.<br>
<br><br>
			Будь певен, Друже, твоя справа житиме і продовжуватиметься у серцях відповідальної молоді нашої країни.
<br><br>
			Присутній!
<br><br>
			Павло Добротворський загинув 18.06.2022 року при виконанні бойового завдання на півдні України.
		</p>
	</div>


    <!-- Текст про команду -->
    <div class="team-wrapper wow fadeInLeft">
